...
# ARQ210619	Jun 06, 2019 - Modify verifications for ['payment']["status"]
...
function sendEmail($to, $from, $subject, $message) {
	//+200319
	$bcc = "mirek@artbymobile.com, reservations@grupoexcellence.com, mcanul@grupoexcellence.com, aruz@grupoexcellence.com, rcarrillo@grupoexcellence.com";
...
//exit;/*
//26-04-19
$HotelFiltro="and (`RES_ID` like  '1%' or `RES_ID` like  '2%' or `RES_ID` like  '3%'  or `RES_ID` like  '6%'  or `RES_ID` like  '7%') ";
...
foreach($reservations as $reservation) {
  ...
  #$IDs[] = $row{'RES_ID'};
    ...
    */
	...
	//+ARQ210619
	if ($paymentSent==1 && isset($payment['payment']) && (
	$payment['payment']["status"]=="CAPTURE_REQUESTED" 
	...
	*/
	...
	//-050319
		//+ARQ210619
		$reservation['FinalStatus'] = "success";				
