...
$query ="SELECT * FROM RECORDS WHERE (INGENICO_TOKEN='' or INGENICO_TOKEN is null) and STATUS=0 AND (MErrMsg='' or MErrMsg is null) and `CHECK_IN` >= '2019-09-25 00:00:00' and `CHECK_IN` < '2019-10-01 00:00:00' and (`RES_ID` like  '1%' or `RES_ID` 
like  '2%' or `RES_ID` like  '3%'  or `RES_ID` like  '6%'  or `RES_ID` like  '7%')";
 ...
 <script>
	...
	function findPayment(){	
	          ...
	          */
	          ...
	          var publisher_name = "excellence1";
